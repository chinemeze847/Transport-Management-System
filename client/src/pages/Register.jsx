...
const Register = () => {
  ...
  return (
    <div className="w-full px-6 min-h-screen py-6 flex items-center justify-center bg-gray-100">
      <div className="w-full lg:w-2/6">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <button
              className="bg-violet-500 disabled:bg-violet-300  flex items-center justify-center gap-2 hover:bg-violet-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              type="submit"
              disabled={isLoading}
            >
              Register
